...
def get_workflow_info(api: ObservatoryApi):
    ...
    workflow_info["Crossref Events Telescope"] = Workflow(
        name="Crossref Events Telescope", workflow_type=WorkflowType(id=wftids["crossref_events"]), extra={}, tags=None
    )
    workflow_info["Crossref Fundref Telescope"] = Workflow(
        name="Crossref Fundref Telescope",
        workflow_type=WorkflowType(id=wftids["crossref_fundref"]),
        extra={},
        tags=None,
    )
    workflow_info["Crossref Metadata Telescope"] = Workflow(
        name="Crossref Metadata Telescope",
        workflow_type=WorkflowType(id=wftids["crossref_metadata"]),
        extra={},
        tags=None,
    )
    workflow_info["Geonames Telescope"] = Workflow(
        name="Geonames Telescope", workflow_type=WorkflowType(id=wftids["geonames"]), extra={}, tags=None
    )
    workflow_info["GRID Telescope"] = Workflow(
        name="GRID Telescope", workflow_type=WorkflowType(id=wftids["grid"]), extra={}, tags=None
    )
    workflow_info["Open Citations Telescope"] = Workflow(
        name="Open Citations Telescope", workflow_type=WorkflowType(id=wftids["open_citations"]), extra={}, tags=None
    )
    workflow_info["OpenAlex Telescope"] = Workflow(
        name="OpenAlex Telescope", workflow_type=WorkflowType(id=wftids["openalex"]), extra={}, tags=None
    )
    workflow_info["ORCID Telescope"] = Workflow(
        name="ORCID Telescope", workflow_type=WorkflowType(id=wftids["orcid"]), extra={}, tags=None
    )
    workflow_info["ROR Telescope"] = Workflow(
        name="ROR Telescope", workflow_type=WorkflowType(id=wftids["ror"]), extra={}, tags=None
    )
    workflow_info["Unpaywall Snapshot Telescope"] = Workflow(
        name="Unpaywall Snapshot Telescope",
        workflow_type=WorkflowType(id=wftids["unpaywall_snapshot"]),
        extra={},
        tags=None,
    )
    workflow_info["Unpaywall Telescope"] = Workflow(
        name="Unpaywall Telescope", workflow_type=WorkflowType(id=wftids["unpaywall"]), extra={}, tags=None
    )
    workflow_info["DOI Workflow"] = Workflow(
        name="DOI Workflow", workflow_type=WorkflowType(id=wftids["doi"]), extra={}, tags=None
    )
