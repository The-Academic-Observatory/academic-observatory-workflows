...
class TestOpenCitationsTelescope(ObservatoryTestCase):
        ...
        env = ObservatoryEnvironment(
            workflows=[
                Workflow(
                    ...
                    class_name="academic_observatory_workflows.open_citations_telescope.open_citations_telescope.OpenCitationsTelescope",
                    cloud_workspace=self.fake_cloud_workspace,
                )
            ]
        )
    ...
    @patch("academic_observatory_workflows.open_citations_telescope.open_citations_telescope.list_releases")
