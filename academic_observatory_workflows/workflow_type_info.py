...
def get_workflow_type_info():
    ...
    workflow_type_info["crossref_metadata"] = WorkflowType(type_id="crossref_metadata", name="Crossref Metadata Telescope")
    ...
    workflow_type_info["unpaywall_snapshot"] = WorkflowType(type_id="unpaywall_snapshot", name="Unpaywall (snapshot) Telescope")
...
if __name__ == "__main__":
    api = get_api_client()
    workflow_type_info = get_workflow_type_info(api)
