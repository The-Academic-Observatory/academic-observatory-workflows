        ...
        self.assert_dag_structure(
            {
                ...
                "branch_updatefiles_or_dataset_release": {"add_dataset_releases", "updatefiles.updatefiles_download"},
